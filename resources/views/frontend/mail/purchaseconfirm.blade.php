                ...
                <div class="row">
                    <div class="col">
                        <a target="_blank" href="#">
                            <img src="{{ asset('assets/frontend/images/logo1.png') }}" data-holder-rendered="true" />
                            </a>
                    </div>
                    <div class="col company-details">
                        ...
                        <div>+88 01322881437</div>
                        {{-- <div>Fortune Fitness Limited</div> --}}
                        <div>House#519,Building
                            2(5th Floor), Road No.1 Dhanmondi,Dhaka-1205</div>
                    </div>
                </div>
            </header>
            <main>
