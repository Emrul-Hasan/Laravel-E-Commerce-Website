...
@section('frontendtitle') Single Product Page @endsection

@section('frontend_content')
   @include('frontend.layouts.inc.breadcrumb', ['pagename' => $product->name])
                ...
                <div class="col-lg-6">
                    <div class="product-single-img">
                        <div class="product-active owl-carousel">
                            ...
                            <div class="item">
                                <img src="{{ asset('uploads/product_photos') }}/{{ $image->product_multiple_image }}" alt="">
                            </div>
                            @endforeach
    ...
    <div class="featured-product-area">
        <div class="container">
            ...
            <div class="row">
                @foreach ($related_products as $reproduct)
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="featured-product-wrap">
                        <div class="featured-product-img">
                            <img src="{{ asset('uploads/product_photos') }}/{{ $reproduct->product_image }}" alt="">
                        </div>
